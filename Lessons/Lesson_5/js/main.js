 ...
 */
    ...
    console.log(squareRectangle(5,2));
...
let addParagraphText = (text_value) => {
...
let addDynamicItemsList = (value_text, count) => {
    document.write(`<ul>`);
...
let sumArrayOfNumbers = (...sumArrayNum) => {
    let sumResult = 0;
...
let replaceItemOfArray = (arr,index1,index2) => {
...
console.log(exchange(10000,listCash,'EUR'));